...
| `grader_utils/answers.py` | Answer extraction and grading rules from Power-SMC's runner | MIT | Moved out of the runner; HumanEval extraction removed (see `he_protocols.py`) |
